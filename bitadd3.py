...
def get_bcaddress_version(strAddress):
  ...
  print " get_bcaddress_version(strAddress)"
...
def main():
	print "main()"
	print b58encode('16UwLL9Risc3QfPqBUvKofHmBQ7wMtjvM')
	print b58decode('16UwLL9Risc3QfPqBUvKofHmBQ7wMtjvM',25)
	print get_bcaddress_version( 'aasdasdL9Risc3QfPqBUvKofHmBQ7wasdasd' )
